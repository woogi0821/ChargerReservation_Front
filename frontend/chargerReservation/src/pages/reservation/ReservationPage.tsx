...
export const ReservationPage = () => {
    ...
    const selectedCharger = location.state?.selectedCharger as Charger | undefined;
    ...
    const validate = (): boolean => {
        ...
        const platePattern = /^[가-힣\d]{2,3}\s*[가-힣]\s*\d{4}$|^\d{2,3}[가-힣]\d{4}$/;
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toastError("예약에 실패했습니다. 다시 시도해주세요.", { position: "bottom-center" });
        } finally {
    ...
    if (!selectedCharger) {
        return (
            <div className="max-w-xl mx-auto p-8 my-10 text-center">
                ...
                <p className="text-zinc-600 font-semibold mb-4">충전기 정보가 없습니다.</p>
        ...
        <>
            ...
            <div className="max-w-xl mx-auto p-8 bg-white rounded-2xl my-10 shadow-xl border border-[#DBEAFE]">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-zinc-500">아래 정보를 확인하고 예약을 확정해주세요.</p>
                </div>
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-xl px-5 py-4 mb-8 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-amber-700 mt-0.5 leading-relaxed">
                            예약 확정 버튼을 누르는 순간부터 <strong>15분간</strong> 예약이 유지됩니다.
                            15분 내로 충전을 시작하지 않으면 자동 취소됩니다.
                        </p>
                    </div>
                </div>
                ...
                {reservationResult && (
                    <div className="space-y-6">
                        ...
                        <div className="bg-[#F5F8FF] border-2 border-[#3B82F6] rounded-2xl p-6 text-center">
                            ...
                            <p className="text-xs text-zinc-400 mt-3">키오스크에서 이 번호를 입력해주세요</p>
                        </div>
                        ...
                        <div className="space-y-2 text-sm">
                            <div className="flex justify-between py-2 border-b border-zinc-100">
                                ...
                                <span className="font-bold text-[#0F172A]">{reservationResult.carNumber}</span>
                            </div>
                            <div className="flex justify-between py-2 border-b border-zinc-100">
                                <span className="text-zinc-500">충전 방식</span>
                                <span className="font-bold text-[#0F172A]">
                                    {CHARGER_TYPE_LABEL[reservationResult.chargerType] ?? reservationResult.chargerType}
                                </span>
                            </div>
                            <div className="flex justify-between py-2 border-b border-zinc-100">
